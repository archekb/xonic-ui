<template>
  <nav class="nav flex-column">
    ...
    <router-link class="nav-link" :to="{name: 'shares'}" v-if="settings.includes('ui.menu.list', 'shares')">
    ...
    <router-link class="nav-link" :to="{name: 'files'}" v-if="settings.includes('ui.menu.list', 'files')">
